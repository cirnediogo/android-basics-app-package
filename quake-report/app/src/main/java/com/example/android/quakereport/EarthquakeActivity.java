...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView earthquakeListView = (ListView) findViewById(R.id.eq_list);
        ...
        if (isConnected) {
            ...
            ((TextView) findViewById(R.id.empty_state)).setText(R.string.no_connection);
        }
    ...
    public void onLoadFinished(Loader<List<Earthquake>> loader, List<Earthquake> earthquakes) {
        ...
        ((TextView) findViewById(R.id.empty_state)).setText(R.string.no_earthquakes);
    }
