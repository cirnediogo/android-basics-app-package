...
//    public static final String USGS_REQUEST_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=5&limit=10";
    ...
    public static final DecimalFormat DECIMAL_FORMATTER = new DecimalFormat("0.0");
    ...
    /**
     * Query the USGS dataset and return an {@link List<Earthquake>} containing the earthquake data.
     */
